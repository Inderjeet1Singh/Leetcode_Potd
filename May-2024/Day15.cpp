...
class Solution {
public:
 void Answer(vector<vector<int>> & dist, vector<vector<int>> & min_dist, int n) {
    ...
    void MiniDis(vector<vector<int>>& grid, vector<vector<int>> & dist, int n) {
